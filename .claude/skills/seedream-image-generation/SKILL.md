...
## Supported Model Parameters (Model ID)
...
- **api_key** *(string, optional)*: API Key to access Volcengine services.
- **model** *(string, optional)*: Endpoint ID corresponding to the model. If not provided, it will read `SEEDREAM_ENDPOINT_ID` from the environment.
...
| Resolution (`分辨率`) | Aspect Ratio (`宽高比`) | Dimensions (`宽高像素值`) |
| :-------------------- | :---------------------- | :------------------------ |
| **2K**                | 1:1                     | 2048x2048                 |
|                       | 4:3                     | 2304x1728                 |
|                       | 3:4                     | 1728x2304                 |
